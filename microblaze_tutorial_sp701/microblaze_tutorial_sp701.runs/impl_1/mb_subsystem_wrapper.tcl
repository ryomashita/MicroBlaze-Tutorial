...
namespace eval ::optrace {
  variable script "/home/r-yamashita/bootLoader/MicroBlaze-Tutorial/microblaze_tutorial_sp701/microblaze_tutorial_sp701.runs/impl_1/mb_subsystem_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/r-yamashita/bootLoader/MicroBlaze-Tutorial/microblaze_tutorial_sp701/microblaze_tutorial_sp701.runs/synth_1/mb_subsystem_wrapper.dcp
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top mb_subsystem_wrapper -part xc7s100fgga676-2 
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mb_subsystem_wrapper_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file mb_subsystem_wrapper_timing_summary_routed.rpt -pb mb_subsystem_wrapper_timing_summary_routed.pb -rpx mb_subsystem_wrapper_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file mb_subsystem_wrapper_bus_skew_routed.rpt -pb mb_subsystem_wrapper_bus_skew_routed.pb -rpx mb_subsystem_wrapper_bus_skew_routed.rpx"
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi mb_subsystem_wrapper.mmi }
