...
----------------------------------------------------------------------------------
--Command: generate_target bd_6c65.bd
--Design : bd_6c65
...
entity bd_6c65 is
  ...
  attribute CORE_GENERATION_INFO of bd_6c65 : entity is "bd_6c65,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_6c65,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_6c65 : entity is "mb_subsystem_system_ila_0.hwdef";
end bd_6c65;

architecture STRUCTURE of bd_6c65 is
  component bd_6c65_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_6c65_ila_lib_0;
  component bd_6c65_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_6c65_g_inst_0;
  component bd_6c65_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_6c65_slot_0_aw_0;
  component bd_6c65_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_6c65_slot_0_w_0;
  component bd_6c65_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_6c65_slot_0_b_0;
  component bd_6c65_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_6c65_slot_0_ar_0;
  component bd_6c65_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_6c65_slot_0_r_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN mb_subsystem_mig_7series_0_0_ui_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0";
...
begin
  ...
  resetn_1 <= resetn;
g_inst: component bd_6c65_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_6c65_ila_lib_0
     port map (
      clk => clk_1,
