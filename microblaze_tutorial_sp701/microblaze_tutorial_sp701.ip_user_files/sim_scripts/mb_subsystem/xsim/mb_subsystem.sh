...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_14 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_11 -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L lib_cdc_v1_0_2 -L axi_uartlite_v2_0_32 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L proc_sys_reset_v5_0_13 -L axi_bram_ctrl_v4_1_8 -L lmb_v10_v3_0_12 -L lmb_bram_if_cntlr_v4_0_22 -L blk_mem_gen_v8_4_6 -L mdm_v3_2_24 -L xlconstant_v1_1_7 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_28 -L axi_vip_v1_1_14 -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_crossbar_v2_1_29 -L gigantic_mux -L xlconcat_v2_1_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mb_subsystem xil_defaultlib.mb_subsystem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mb_subsystem -key {Behavioral:sim_1:Functional:mb_subsystem} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f2d6.protoinst" -protoinst "protoinst_files/bd_6c65.protoinst" -protoinst "protoinst_files/mb_subsystem.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mb_subsystem.wdb xsim.dir libdpi.so)
